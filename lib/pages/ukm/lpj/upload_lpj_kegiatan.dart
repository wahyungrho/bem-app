...
class UploadLPJKegiatan extends StatefulWidget {
  final ProposalModel? proposalModel;
  const UploadLPJKegiatan({this.proposalModel, Key? key}) : super(key: key);

  @override
  _UploadLPJKegiatanState createState() => _UploadLPJKegiatanState();
}

class _UploadLPJKegiatanState extends State<UploadLPJKegiatan> {
  File? selectedFile;
  ...
  Widget build(BuildContext context) {
    ...
    Widget buttonActionUploadLPJKegiatan() {
      return Container(
          margin: const EdgeInsets.only(
            top: 30,
          ),
                ...
                onPressed: () {
                  if (selectedFile == null) {
                    ...
                    Timer(const Duration(milliseconds: 3000), () async {
                      isLoading = false;
                      String? response = await lpjServices.uploadLPJEvent(
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text("Upload LPJ Kegiatan"),
      ),
      body: Padding(
